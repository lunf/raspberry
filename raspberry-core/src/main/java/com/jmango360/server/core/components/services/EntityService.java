...
public interface EntityService<Entity> {
	/**
	 * @param entity
	 *            - persist a new Entity object to the database
	 * @see Entity
	 */
	...
	/**
	 * @param id
	 *            Long - the primary key of the Entity
	...
	/**
	 * @param id
	 *            Long - removes this entity from the cache and database with
	 *            this ID
	 * @see Entity
	 */
	...
	/**
	 * @param entity
	 *            Entity - merges changes to this Entity and persists the
	 ...
	 * 
	 * @param id
	 *            Long - ID of the entity to check
